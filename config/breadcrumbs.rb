...
crumb :admin_corporation_corporate_admin_users do |corporation|
  link '施設管理者一覧', admin_corporation_corporate_admin_users_path
  parent :admin_corporation, corporation
end
crumb :new_admin_corporation_corporate_admin_user do |corporation|
  link '施設管理者新規登録', new_admin_corporation_corporate_admin_user_path
  parent :admin_corporation_corporate_admin_users, corporation
end
crumb :admin_corporation_corporate_admin_user do |corporation, corporate_admin_user|
  link '施設管理者詳細', admin_corporation_corporate_admin_user_path(corporation, corporate_admin_user)
  parent :admin_corporation_corporate_admin_users, corporation
end
crumb :edit_admin_corporation_corporate_admin_user do |corporation, corporate_admin_user|
  link '施設管理者編集', edit_admin_corporation_corporate_admin_user_path(corporation, corporate_admin_user)
  parent :admin_corporation_corporate_admin_user, corporation, corporate_admin_user
end
...
# admin_corporation_facility_facility_pack_plans
crumb :new_admin_corporation_facility_facility_pack_plan do |corporation, facility|
  link '施設利用パック料金プラン追加', new_admin_corporation_facility_facility_pack_plan_path(corporation, facility)
  parent :admin_corporation_shop_facility, corporation, facility.shop, facility
end

crumb :edit_admin_corporation_facility_facility_pack_plan do |corporation, facility, facility_pack_plan|
  link '施設利用パック料金プラン編集', edit_admin_corporation_facility_facility_pack_plan_path(corporation, facility, facility_pack_plan)
  parent :admin_corporation_shop_facility, corporation, facility.shop, facility
end
